    ...
    public void searchWithId(int id){
        ...
        while (current != null) {
            if (current.data.id == id) {
                isFound = true;
                 ...
                 current = null;
                // Searching in sorted list
                System.out.println("Searching in sorted list" + " "+"Search Time :"+ (endTime - startTime) + " nanoseconds");
            } else {
        ...
        if (isFound == false) {
            endTime = System.nanoTime();
            System.out.println("not found in sorted list" + " "+"Search Time :"+ (endTime - startTime) + " nanoseconds");
        }
               ...
               isFound = false;
                ...
                while (current != null) {
                    if (current.data.id == id) {
                        ...
                        current = null;
                        // Searching in unsorted list
                        System.out.println("Searching in unsorted list" + " "+"Search Time :"+ (endTime - startTime) + " nanoseconds");
                    }
                    else {current = current.next;}
                }
        if (isFound == false) {
            endTime = System.nanoTime();
            System.out.println("not found in unsorted list" + " "+"Search Time :"+ (endTime - startTime) + " nanoseconds");
        }
    // search with Binary search tree
                        ...
                        while (bst != null) {
                            if (bst.data.id == id) {
                                isFound = true;
                                endTime = System.nanoTime();
                                System.out.println("Searching in binarySearchTree"+ " "+"Search Time :" + (endTime - startTime) + " nanoseconds");
                                bst = null;
                                continue;
                        ...
                        if (isFound == false) {
                            endTime = System.nanoTime();
                            System.out.println("ID not found in BinaryTree" +"Search Time :"+ (endTime - startTime) + " nanoseconds");
                        }
